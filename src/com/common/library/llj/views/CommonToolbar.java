...
public class CommonToolbar extends LinearLayout {
    ...
    private void initViews(Context context, AttributeSet attrs) {
        mDefaultDrawablePadding = DensityUtils.dp2px(context, 5);
        mDefaultLeftOrRightPadding = DensityUtils.dp2px(context, 15);
        ...
        mContainRl = (RelativeLayout) findViewById(R.id.height_wrap_rl);
    ...
    public void setLeftTextPadding(int paddingLeft) {
        if (paddingLeft != 0) {
            paddingLeft = DensityUtils.dp2px(getContext(), paddingLeft);
    ...
    public void setLeftTextWithDrawable(@DrawableRes int res, int drawablePadding) {
        if (res != 0) {
            ...
            if (drawablePadding != 0) {
                drawablePadding = DensityUtils.dp2px(getContext(), drawablePadding);
            }
    ...
    public void setRightText(String str, int paddingRight) {
        if (!TextUtils.isEmpty(str)) {
            getRightTextView().setText(str);
            if (paddingRight != 0) {
                paddingRight = DensityUtils.dp2px(getContext(), paddingRight);
    ...
    public void setRightDrawablePadding(int drawablePadding) {
        getRightTextView().setCompoundDrawablePadding(DensityUtils.dp2px(getContext(), drawablePadding));
    }
