 ...
 */
package com.common.library.llj.sectionedRecyclerView;
...
public abstract class SectionedRecyclerViewAdapter<H extends RecyclerView.ViewHolder,
    ...
    /**
     * 根据section的count和每个section中item的count计算总的count
     *
     * @return
     */
    ...
    public int[] getPositionWithinSection(int position) {
        int[] a = new int[2];
        a[0] = sectionForPosition[position];
        a[1] = positionWithinSection[position];
        return a;
    }
     ...
     */
    public abstract boolean hasFooterInSection(int section);

    /**
     * Creates a ViewHolder of class H for a Header
     */
    public abstract H onCreateSectionHeaderViewHolder(ViewGroup parent, int viewType);

    /**
     * Creates a ViewHolder of class F for a Footer
     */
    public abstract F onCreateSectionFooterViewHolder(ViewGroup parent, int viewType);
     ...
     */
    public abstract void onBindSectionHeaderViewHolder(H holder, int section);

    /**
     * Binds data to the footer view of a given section
     */
    public abstract void onBindSectionFooterViewHolder(F holder, int section);

    /**
     * Binds data to the item view for a given position within a section
     */
    public void onBindItemViewHolder(VH holder, int section, int sectionPosition) {

    }

    public void onBindItemViewHolder(VH holder, int section, int sectionPosition, int position) {
