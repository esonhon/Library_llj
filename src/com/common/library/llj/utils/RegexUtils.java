...
//    public static final String PHONE_NUMBER_REGEX = "^1{1}(3{1}\\d{1}|5{1}[012356789]{1}|8{1}[035689]{1})\\d{8}$";
     ...
     * 数字或字母
     */
    private static final String NUMBER_OR_WORD_REGEX = "^[A-Za-z0-9\\-]+$";
    ...
    public static boolean isMobile(String string) {
        return string != null && string.length() == 11 && string.matches(MOBILE_REGEX);
    }

    public static boolean isMobileOrEmail(String string) {
        return string != null && (string.matches(EMAIL_REGEX) || string.matches(MOBILE_REGEX));
    }
     ...
     * @return
     */
    public static boolean isNumberOrWord(String string) {
        return string != null && string.matches(NUMBER_OR_WORD_REGEX);
    }
}
