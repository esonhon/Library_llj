...
public class PhotoUtil {
    ...
    public static ExternalImageInfo getImageInfoByPath(Context context, String fileName) {
        ...
        try {
            ...
            externalImageInfo.dateTaken = ParseUtil.parseLong(cursor.getString(cursor.getColumnIndex(MediaStore.Images.Media.DATE_TAKEN)));
            externalImageInfo.longitude = NumberUtil.doubleStringToInteger(cursor.getString(cursor.getColumnIndex(MediaStore.Images.Media.LONGITUDE)));
            externalImageInfo.latitude = NumberUtil.doubleStringToInteger(cursor.getString(cursor.getColumnIndex(MediaStore.Images.Media.LATITUDE)));
