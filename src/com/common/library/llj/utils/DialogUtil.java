...
public class DialogUtil {
    ...
    public static AlertDialog showCommonDialog(Context context, String title, String message, final AlertDialog.OnClickListener positiveClickListener, final AlertDialog.OnClickListener negativeClickListener) {
        ...
        builder.setPositiveButton(context.getResources().getString(R.string.common_confirm), new android.app.AlertDialog.OnClickListener() {
        ...
        builder.setNegativeButton(context.getResources().getString(R.string.common_cancel), new android.app.AlertDialog.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
