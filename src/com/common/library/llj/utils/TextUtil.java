...
public class TextUtil {
    ...
    public static void setText(TextView textView, CharSequence destination) {
        setText(textView, destination, null, false);
    }
    ...
    public static final void setImageAfterTv(Context context, int otherWidth, String str, int tagWidth, int resId, String tagStr, TextView textTv, TextView imageTv) {
        int diaplayWidth = DisplayUtil.getWidthPixels(context);// 屏幕宽分辨率
        float strWidth = getTextViewLength(textTv, str);// 字符串所占长度
        int firstShortWidthPx = diaplayWidth - DisplayUtil.dp2px(context, otherWidth);// 第一行可用最小长度
        ...
        if (strWidth < firstShortWidthPx) {
            ...
            params.leftMargin = DisplayUtil.dp2px(context, 5);
            imageTv.setLayoutParams(params);
            imageTv.setWidth(DisplayUtil.dp2px(context, tagWidth));
            ...
            imageTv.setLayoutParams(params);
            imageTv.setWidth(DisplayUtil.dp2px(context, tagWidth));
            textTv.setWidth(diaplayWidth - DisplayUtil.dp2px(context, otherWidth));
        }
    }
}
